...
import { FetchBooks, FetchPosts, CreatePost, DeletePost } from '../../../Controllers/ForumPostController.js';
import Spinner from '../components/Spinner.jsx';
import { MdOutlineAddBox, MdOutlineDelete, MdInfoOutline } from 'react-icons/md';
...
const HomeAdmin = () => {
  ...
  const filteredPosts = posts.filter(post =>
    post?.Book_Name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
            ...
            {loading ? (
              ...
              <div className="overflow-x-auto">
                {filteredPosts.length === 0 ? (
                  <p className="text-center text-gray-500 py-8">There are no posts {!showPostForm && 'Create one!'}</p>
                ) : (
                  <table className="min-w-full bg-white border border-gray-200">
                    <thead className="bg-gray-100">
                      <tr>
                        ...
                        <th className="py-3 px-4 border-b text-left">Details/Actions</th>
                      </tr>
                    </thead>
                    <tbody>
